...
namespace Soulmate_Remastered.Classes.GameObjectFolder.EntityFolder.EnemyFolder
{
    class EnemyBlott : AbstractEnemy
    {
        ...
        public EnemyBlott(Vector2f spawnPos)
        {
            ...
            drops = new AbstractItem[] { new Gold(), new TestItem(), new FusionPotion (FusionPotion.fusionPotionSize.small), new HealPotion(HealPotion.healPotionSize.small), new Sword((float)(50 * random.NextDouble()), (float)(50 * random.NextDouble()), (float)(50 * random.NextDouble())) };
